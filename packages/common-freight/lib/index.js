import { useState as P, useEffect as ye } from "react";
function Ee(e, t) {
  return function() {
    return e.apply(t, arguments);
  };
}
const { toString: qe } = Object.prototype, { getPrototypeOf: Y } = Object, q = /* @__PURE__ */ ((e) => (t) => {
  const n = qe.call(t);
  return e[n] || (e[n] = n.slice(8, -1).toLowerCase());
})(/* @__PURE__ */ Object.create(null)), A = (e) => (e = e.toLowerCase(), (t) => q(t) === e), I = (e) => (t) => typeof t === e, { isArray: F } = Array, B = I("undefined");
function Ie(e) {
...
const ze = I("string"), R = I("function"), be = I("number"), M = (e) => e !== null && typeof e == "object", Je = (e) => e === !0 || e === !1, U = (e) => {
  if (q(e) !== "object")
    return !1;
  const t = Y(e);
  return (t === null || t === Object.prototype || Object.getPrototypeOf(t) === null) && !(Symbol.toStringTag in e) && !(Symbol.iterator in e);
}, $e = A("Date"), Ve = A("File"), We = A("Blob"), Ke = A("FileList"), Xe = (e) => M(e) && R(e.pipe), Ge = (e) => {
  let t;
...
const Re = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : global, Oe = (e) => !B(e) && e !== Re;
function X() {
  const { caseless: e } = Oe(this) && this || {}, t = {}, n = (r, s) => {
    const o = e && Se(t, s) || s;
    U(t[o]) && U(r) ? t[o] = X(t[o], r) : U(r) ? t[o] = X({}, r) : F(r) ? t[o] = r.slice() : t[o] = r;
  };
  for (let r = 0, s = arguments.length; r < s; r++)
    arguments[r] && D(arguments[r], n);
  return t;
}
const Ze = (e, t, n, { allOwnKeys: r } = {}) => (D(t, (s, o) => {
  n && R(s) ? e[o] = Ee(s, n) : e[o] = s;
  ...
  for (; t-- > 0; )
    n[t] = e[t];
  return n;
}, st = /* @__PURE__ */ ((e) => (t) => e && t instanceof e)(typeof Uint8Array < "u" && Y(Uint8Array)), ot = (e, t) => {
...
), oe = (({ hasOwnProperty: e }) => (t, n) => e.call(t, n))(Object.prototype), ut = A("RegExp"), Ae = (e, t) => {
...
}, pt = (e, t) => (e = +e, Number.isFinite(e) ? e : t), $ = "abcdefghijklmnopqrstuvwxyz", ie = "0123456789", Te = {
  DIGIT: ie,
  ALPHA: $,
  ALPHA_DIGIT: $ + $.toUpperCase() + ie
}, ht = (e = 16, t = Te.ALPHA_DIGIT) => {
  let n = "";
  const { length: r } = t;
  for (; e--; )
    n += t[Math.random() * r | 0];
...
const yt = (e) => {
  ...
  return n(e, 0);
}, Et = A("AsyncFunction"), wt = (e) => e && (M(e) || R(e)) && R(e.then) && R(e.catch), a = {
  isArray: F,
  isArrayBuffer: we,
  isBuffer: Ie,
  isFormData: Ge,
  ...
  function l(f, d, w) {
    ...
    if (f && !w && typeof f == "object") {
      if (a.endsWith(d, "{}"))
        ...
        return d = Ne(d), b.forEach(function(x, He) {
          !(a.isUndefined(x) || x === null) && t.append(
            // eslint-disable-next-line no-nested-ternary
            i === !0 ? ae([d], He, o) : i === null ? d : d + "[]",
            h(x)
          );
        }), !1;
    }
    return G(f) ? !0 : (t.append(ae(w, d, o), h(f)), !1);
  }
...
}, At = typeof URLSearchParams < "u" ? URLSearchParams : ee, Tt = typeof FormData < "u" ? FormData : null, gt = typeof Blob < "u" ? Blob : null, xt = {
  isBrowser: !0,
  classes: {
    URLSearchParams: At,
    FormData: Tt,
...
}, _e = typeof window < "u" && typeof document < "u", Nt = ((e) => _e && ["ReactNative", "NativeScript", "NS"].indexOf(e) < 0)(typeof navigator < "u" && navigator.product), Pt = typeof WorkerGlobalScope < "u" && // eslint-disable-next-line no-undef
...
const Kt = typeof XMLHttpRequest < "u", Xt = Kt && function(e) {
  return new Promise(function(n, r) {
    ...
    u.open(e.method.toUpperCase(), Ce(E, e.params, e.paramsSerializer), !0), u.timeout = e.timeout;
    function S() {
      if (!u)
        return;
      const d = T.from(
    ...
    }), a.isUndefined(e.withCredentials) || (u.withCredentials = !!e.withCredentials), i && i !== "json" && (u.responseType = e.responseType), typeof e.onDownloadProgress == "function" && u.addEventListener("progress", fe(e.onDownloadProgress, !0)), typeof e.onUploadProgress == "function" && u.upload && u.upload.addEventListener("progress", fe(e.onUploadProgress)), (e.cancelToken || e.signal) && (p = (d) => {
...
const de = (e) => `- ${e}`, Gt = (e) => a.isFunction(e) || e === null || e === !1, Ue = {
  getAdapter: (e) => {
    e = a.isArray(e) ? e : [e];
    const { length: t } = e;
    let n, r;
    ...
    for (let o = 0; o < t; o++) {
      n = e[o];
      let i;
      if (r = n, !Gt(n) && (r = v[(i = String(n)).toLowerCase()], r === void 0))
...
function pe(e) {
  return K(e), e.headers = T.from(e.headers), e.data = W.call(
    e,
    e.transformRequest
  ), ["post", "put", "patch"].indexOf(e.method) !== -1 && e.headers.setContentType("application/x-www-form-urlencoded", !1), Ue.getAdapter(e.adapter || ne.adapter)(e).then(function(r) {
    ...
    return De(r) || (K(e), r && r.response && (r.response.data = W.call(
      e,
      e.transformResponse,
      r.response
...
const en = Z;
function je(e) {
  const t = new j(e), n = Ee(j.prototype.request, t);
...
y.mergeConfig = C;
y.AxiosHeaders = T;
y.formToJSON = (e) => Be(a.isHTMLForm(e) ? new FormData(e) : e);
...
function sn(e, t) {
  const [n, r] = P(!0), [s, o] = P(), [i, c] = P();
  return ye(() => {
    console.log("API######################################"), r(!0), tn(e, t).then((p) => {
      c(p.data);
    }, o).catch(o).finally(() => {
      r(!1);
    });
  }, [e, t]), { loading: n, error: s, data: i };
}
function on(e, t, n, r) {
  const [s, o] = P(!0), [i, c] = P(), [p, h] = P();
  return ye(() => {
    !n || !r || (o(!0), nn(e, t, n, r).then((l) => {
      h(l.data);
    }, c).catch(c).finally(() => {
      o(!1);
    }));
  }, [e, r, n, t]), { loading: s, error: i, data: p };
}
export {
  on as useMarketRates,
  sn as usePorts
};
